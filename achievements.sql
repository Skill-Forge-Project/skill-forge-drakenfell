...
INSERT INTO achievements (achievement_id, achievement_name, achievement_description, achievement_picture, "language", quests_number_required) 
VALUES
	...
	('ACH-PY-004','Python Arcane Adept','Solve 60 Python Quests','Python/python-4.png','Python',60) ON CONFLICT DO NOTHING;
...
INSERT INTO achievements (achievement_id,achievement_name,achievement_description,achievement_picture,"language",quests_number_required) VALUES
	 ...
	 ('ACH-CS-002','C# Adept','Solve 20 C# Quests','CS/cs-1.png','C#',20) ON CONFLICT DO NOTHING;
...
INSERT INTO achievements (achievement_id,achievement_name,achievement_description,achievement_picture,"language",quests_number_required) VALUES
	 ...
	 ('ACH-GEN-002','Early Bird','Thanks for joining us early!','General/early_bird.png','General',1) ON CONFLICT DO NOTHING;